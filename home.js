...
function loadVendingItems() {
    ...
    $.ajax({
        ...
        var vendingInfo = '<div class="vending-items col-sm-4" onclick="selectedItem('+ id +','+ name +')" role="button" id="item-'+ id +'" style="text-align: left; margin-bottom: 30px; margin-top 30px">';
